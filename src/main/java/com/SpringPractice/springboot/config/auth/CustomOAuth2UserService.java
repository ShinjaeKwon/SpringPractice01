...
import com.SpringPractice.springboot.config.auth.dto.OAuthAttributes;
import com.SpringPractice.springboot.config.auth.dto.SessionUser;
import com.SpringPractice.springboot.domain.user.User;
import com.SpringPractice.springboot.domain.user.UserRepository;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        //이후 네이버등 다른 소셜 로그인도 이 클래스를 사용한다.
